...
//系统参数配置
// $rdGlobal['lz_reBackTime']=155*3600*24; //流转标提前多少时间回购 0为当即，3600 为提前1小时
$rdGlobal['lz_reBackTime']=3600*24; //流转标提前多少时间回购 0为当即，3600 为提前1小时
$rdGlobal['lz_awardfirst']=false; //流转标奖励 true投标成功就发放 false回购时发放
$rdGlobal['pj_reBackTime']=3600*24; //票据标提前多少时间回购 0为当即，3600 为提前1小时
$rdGlobal['pj_awardfirst']=false; //票据标奖励 true投标成功就发放 false回购时发放
$rdGlobal['serial_on']=false; //后台U盾登录，false关闭,true开启
$rdGlobal['uc_on']=false; //UC接口开启，false关闭,true开启
$rdGlobal['uc_key']="appdor.123"; //UC 加密密钥
