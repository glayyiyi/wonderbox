...
class ecpssPayment{
	public static function ToSubmit($payment){
		...
		$ReturnURL = "http://demoa.erongdu.com/modules/payment/ecpss_return.php";//支付完成后 web 页面跳转显示支付结果
		$AdviceURL = "http://demoa.erongdu.com/modules/payment/ecpss_return.php";//支付完成后，后台接收支付结果，可用来更新数据库值
