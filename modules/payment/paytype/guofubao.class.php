...
class guofubaoPayment {
    ...
    public static function ToSubmit($payment){
		...
		//$frontMerUrl = "http://www.cnaidai.com/index.php?user&q=code/account/recharge"; 
		//$backgroundMerUrl = "http://www.cnaidai.com/index.php?user&q=code/account/recharge"; 

		$tranDateTime = $Date;     
		$virCardNoIn = '0000000002000129699';      
		$tranIP = $ipAddr;           
		...
		$signValue='version=['.$version.']tranCode=['.$tranCode.']merchantID=['.$merchantID.']merOrderNum=['.$merOrderNum.']tranAmt=['.$tranAmt.']feeAmt=['.$feeAmt.']tranDateTime=['.$tranDateTime.']frontMerUrl=['.$frontMerUrl.']backgroundMerUrl=['.$backgroundMerUrl.']orderId=[]gopayOutOrderId=[]tranIP=['.$tranIP.']respCode=[]VerficationCode=[wzyh577577]';
