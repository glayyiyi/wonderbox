...
<script type="text/javascript" src="<? if (!isset($this->magic_vars['tempdir'])) $this->magic_vars['tempdir'] = ''; echo $this->magic_vars['tempdir']; ?>/media/js/index.js"></script>
	...
	<body>
		...
		<div class="branding">
			<div class="head">
            	<a class="" href="/"><div class="logo fl"></div></a>
                <div class="nav fl">
                	<ul class="navList">
                    	<li><a class="" href="/">首页</a>
                    	<p class="subMenu hide"><a href="/question/index.html">平台原理</a><a href="/fygz/index.html">资费说明</a> </p></li>
                        <li><a href="/invest/index.html?order=account_up">我要投资</a>
                        	<p class="subMenu hide"><a href="#">信托</a><a href="#">理财</a> <a href="#">储蓄</a> <a href="#">基金</a> <a href="#">保险</a></p>
                        	<!-- <p class="subMenu hide"><a href="/publish/index.html?biao_type=xin">信用标</a> <a href="/publish/index.html?biao_type=lz">流转标</a> <a href="/publish/index.html?biao_type=jin">净值标</a><a href="/publish/index.html?biao_type=miao">秒还标</a> <a href="/publish/index.html?biao_type=fast">抵押标</a></p> -->
                        </li>
                        <!-- <li><a href="/borrow/index.html">我要贷款</a></li> -->
                        <li><a href="/index.action?user">我的账户</a>
                        <p class="subMenu hide"><!-- <a href="/index.php?user&q=code/user/myfriend">我的好友</a> -->
                        <a href="/index.php?user&q=code/account/recharge_new">充值提现</a><a href="/index.php?user&q=code/user/reginvite">邀请好友</a> </p></li>
                       	<li><a href="/onlineservice/index.html">咨询服务</a>
                       	<p class="subMenu hide"><a href="/principal/index.html">本金保障</a><a href="/onlineservice/index.html">在线客服</a> </p></li> 
                        <li><a href="/aboutus/index.html">关于我们</a>
                        <p class="subMenu hide"><a href="/aboutus/index.html">公司简介</a><a href="/intro/index.html">联系我们</a> </p></li>
                    </ul>                
                </div>
                <div class="info fr">
                  <p class="name"><label class="fl"> 
				...
				<a href="/?user&q=going/logout">退出</a>
				 <? else: ?>
				 <a href="/index.action?user&q=going/login">登录</a> <? if (!isset($this->magic_vars['_G']['system']['con_is_reg_open'])) $this->magic_vars['_G']['system']['con_is_reg_open']=''; ;if (  $this->magic_vars['_G']['system']['con_is_reg_open']): ?> | 
				 <a href="/index.action?user&q=going/getreg">注册</a><? endif; ?>
				 <? endif; ?>
				
				<? endif; ?>
				</label> <a class="fr" href="#" onclick="alert('请用键盘快捷键Ctrl+D，将本网站快速加入收藏。');">加入收藏</a></p>
              </div>
            </div>
		</div>
		<!-- end 标记(logo)区域 -->
		<div class="container">
			...
			<div class="subNavBg m_b_6 clearfix">
				<div class="fl loginBar">
					...
					<a class="longin_apply" href="/vip/index.html">VIP申请</a>
					...
					<a class="longin_enter" href="/index.action?user&q=going/login">登录</a>
                		...
                		<form action="/index.php?user&q=going/login" method="post" id="login_sub">
							<div class="login">
								...
								<? if (!isset($this->magic_vars['_G']['system']['con_is_reg_open'])) $this->magic_vars['_G']['system']['con_is_reg_open']=''; ;if (  $this->magic_vars['_G']['system']['con_is_reg_open']): ?><a href="/index.action?user&q=going/getreg" class="btnnew btn_login" target=_blank>立即注册</a><? endif; ?>
