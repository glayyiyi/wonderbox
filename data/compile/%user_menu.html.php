...
<div class="user_menus">
	<div class="title" id="user_title_touzi"><span onclick="changeUserMenu('touzi')">&nbsp;</span>我的菜单</div>
	<div class="menu">
...
<div class="user_menus">
	<div class="title" id="user_title_touzi"><span onclick="changeUserMenu('touzi')">&nbsp;</span>投资管理</div>
	<div class="menu">
		<ul id="user_menu_touzi" style="display:block">
...
<div class="user_menus">
	<div class="title" id="user_title_touzi"><span onclick="changeUserMenu('touzi')">&nbsp;</span>个人设置</div>
	<div class="menu">
		<ul id="user_menu_touzi" style="display:block">
...
<div class="user_menus">
	<div class="title" id="user_title_safe" ><span onclick="changeUserMenu('safe')">&nbsp;</span>理财顾问中心</div>
	<div class="menu">
		<ul id="user_menu_safe">
